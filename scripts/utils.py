...
def create_model(model_name='fasterrcnn', 
    ...
    if model_name == 'ssd':
        ...
        model = fasterrcnn_resnet50_fpn(weights=None, weights_backbone=ResNet50_Weights, num_classes=num_classes)
        print(f"antal klasser: {num_classes}")
    elif model_name == 'retinanet':
        model = retinanet_resnet50_fpn_v2(weights=None, weights_backbone=ResNet50_Weights.IMAGENET1K_V1, num_classes=num_classes)
    else:
